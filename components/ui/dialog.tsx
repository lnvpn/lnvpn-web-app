...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Description
    ref={ref}
    className={cn("text-md font-base text-text dark:text-darkText", className)}
    {...props}
  />
));
